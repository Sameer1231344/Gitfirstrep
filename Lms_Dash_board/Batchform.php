...
<div class="col-lg-12">
        <div class="card">
           <div class="card-body">
           <div class="card-title">BatchRegistration Form</div>
           <hr>
            <form>
           <div class="form-group">
            ...
            <?php while ($data1=mysqli_fetch_assoc($row1)) {
                    ...
                    ?>
            <option><?php echo $data1['curriculumName']?></option>
           <?php }?>
          </select>
           </div>
           <div class="form-group">
           ...
           <div class="form-group">
            <label for="input-8">Teacher ID</label>
            <select type="text" class="form-control form-control-rounded" id="input-7" placeholder="Enter Your Email Address">
            <?php while ($data2=mysqli_fetch_assoc($row2)) {
                    
                    ?>
            <option><?php echo $data2['TeacherName']?></option>
           <?php }?>
            </select>
           </div>
