        ...
        <div class="card">
           ...
           <div class="form-group">
            ...
            <?php while ($data=mysqli_fetch_assoc($rows)) {
                    ...
                    ?>
            <option><?php echo $data['BatchName']?></option>
           <?php }?>
          </select>
           </div>
           <div class="form-group">
            <label for="input-8">Contact</label>
            <input type="int" class="form-control form-control-rounded" id="input-8" placeholder="Enter Your Mobile Number">
           </div>
           <div class="form-group">
           ...
           <div class="form-group">
            <label for="input-10">Date of Birth</label>
            <input type="date" class="form-control form-control-rounded" id="input-10" placeholder="Confirm Password">
           </div>
